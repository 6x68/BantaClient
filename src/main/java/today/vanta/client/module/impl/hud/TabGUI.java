...
public class TabGUI extends Module {
    ...
    private void onRenderOverlay(RenderOverlayEvent event) {
        ...
        float height = categories.length * ROW_HEIGHT;
        ...
        for (Category category : categories) {
            CFonts.SFPT_REGULAR_18.drawStringWithShadow(
                    category.name,
                    xPos + 0.5f,
                    yDraw - 1,
                    Color.WHITE
        ...
        // Module panel — pulled outside the category loop, only drawn once.
        if (isExpanded) {
            ...
            if (!currentModules.isEmpty()) {
                ...
                // Highlight row for the selected module, same pattern as the category gradient.
                GradientRectangle
